...
<!-- TODO (Gaurav, in your own words — these reflections must stay yours):
The verified analysis changed some numbers your reflections reference.
Update them yourself so Task 2 and Task 3 are consistent:
  - Sea freight peaked ~3x baseline (index ~302, 2022 Q3), not "65%".
  - Q5 says imports "flowed on as normal" — check this against your
    rendered Figure 2 once trade.csv is processed (trade.csv could not
    be verified externally), and restate in your own words.
  - You may also want to mention catching the A3538843R → A3538843C
    lookup typo during verification (it fits your Q4 theme perfectly).
